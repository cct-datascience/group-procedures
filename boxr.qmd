...
If you plan to only use `boxr` interactively (i.e. on your own laptop by running R code and not part of any script running automatically somewhere), you can authenticate with an [interactive app](https://r-box.github.io/boxr/articles/boxr-app-interactive.html) using a client ID and secret.
