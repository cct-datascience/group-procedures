...
Other options for archiving data include [Dryad](https://datadryad.org/) and [UA ReDATA](https://data.library.arizona.edu/supported-platforms/redata). On Zenodo (possibly other repositories), there is a metadata field for contributor which is distinct from author.
