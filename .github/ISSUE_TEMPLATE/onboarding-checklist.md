...
- [ ] Sign up for and attend a [Benefits Orientation](https://hr.arizona.edu/employees-affiliates/new-ua/new-employee-orientation-programs) _scheduled for 8/23_
...
- [ ] UA UITS Accounts, starting here:  [https://account.arizona.edu/welcome](https://account.arizona.edu/welcome)
...
- [ ] GitHub setup
    ...
    - [ ] Get added to our group's GitHub org: [https://github.com/cct-datascience](https://github.com/cct-datascience)
...
- [ ] Log in to get edit access to the website. Navigate to [https://datascience.cct.arizona.edu/user](https://datascience.cct.arizona.edu/user). Don't log in using the obvious log in form; click on "Log in with NetAuth" (or similar) and log in using your NetID credentials.
