...
-   Update workshop info on our [workshops website page](https://datascience.cct.arizona.edu/workshops)
    ...
    -   Publish changes and make sure workshop event now shows up in "Previous Workshops" section of workshops page (it might not move there until the following day).
