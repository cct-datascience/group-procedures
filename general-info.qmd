...
*   General issues in the building
    *   Submit a ticket for either IT support or misc. Building related issues [https://keating.bio5.org/ticket_support/tickets.php](https://keating.bio5.org/ticket_support/tickets.php)
...
*   Mail. There is a group mailbox in the mailroom on the N side of the building. 
...
*   Inform Kristina by email of upcoming vacation or leave as soon as is practical; _at least two weeks in advance_.
*   Employees must report their time by 10:00 a.m. on the Friday of a non-pay week. Supervisors (time approvers) must approve time by 5:00 p.m. on that day. See https://hr.arizona.edu/managers-supervisors/compensation/time-reporting-deadlines
*   _For Appointed personnel, you only need to report leave time (sick, vacation, jury duty, etc): https://hr.arizona.edu/managers-supervisors/compensation/time-reporting-exception-reporters-within-uaccess-employee holidays and campus closures are automatically added to your time sheet. For more information on winter holiday closure: https://hr.arizona.edu/employees-affiliates/leaves/university-winter-closure_
...
*   Seminars, webinars, and classes that will help you gain skills and knowledge related to your current work or work that you would like to do. For example:
  ...
  * [Plant Phenome Journal](https://dl.sciencesocieties.org/publications/tppj/webinars)
  * [Rstudio Webinars](https://resources.rstudio.com/webinars)
  * [Alda-Kavli center for Communicating Science Webinars](https://www.aldacenter.org/aklc/webinars)
...
* All University of Arizona employees age 21-45 should consider joining "Tucson Young Professionals". The U of A covers membership fees (normally $200/y) - see [this website for more information](https://olod.arizona.edu/content/tucson-young-professionals-partnership)).

## Publishing [Under construction]

Documentation, GitHub threads, Slack Discussions are all great places to find inspriation for publishable units; peer reviewed publications help provide an academic foundation for our group's contributions, with outreach as well as future funding.
