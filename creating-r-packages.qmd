...
For example, [`volcalc`](https://github.com/Meredith-Lab/volcalc) and [`azmetr`](https://github.com/uace-azmet/azmetr) were both initially developed as [incubator projects](https://osf.io/tzmhp/wiki/Incubator%20Program/).
