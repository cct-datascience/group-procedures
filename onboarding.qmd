...
-   Review [DIAG Group Code of Conduct](code-of-conduct.qmd)
...
-   Set up a UA NetID account at <https://it.arizona.edu/getting-started/staff> to get access to everything at the university\
...
-   Create accounts on the following collaboration tools (details provided below)
    ...
    -   UITS Accounts, starting here: <https://account.arizona.edu/welcome>
    ...
    -   GitHub
        ...
        -   See [here](https://osf.io/tzmhp/wiki/2-Factor%20Authentication%20for%20GitHub/) for more about 2FA for GitHub and SSH protocols
        -   If you don't already have an account sign up at (https://github.com), used to organize our work. Also join these organizations:
        -   CCT Data Science group: <https://github.com/cct-datascience>
        -   PEcAn: <https://github.com/PecanProject>
        -   Agriculture Processing Pipeline: <https://github.com/agpipeline>
        -   GenoPhenoEnvo: <https://github.com/genophenoenvo>
    -   ZenHub (<https://www.zenhub.com/>), which interfaces with GitHub and we use for group project maangement
    ...
    -   Create accounts on relevant Slack channels:
        ...
        -   PEcAn: <https://pecanproject.slack.com>
...
-   Participate in daily standup meetings, weekly sprint planning/retrospective meetings, and [weekly outreach hour](https://hackmd.io/fxo335XYQXGUpIm6c46TkQ).
    Review [project management OSF page](https://osf.io/tzmhp/wiki/Project%20Management/) to prepare for these
...
Should be completed by ALL personnel working on the DARPA project.
Complete training by the end of the first week.
Send signed copies of appendix A&B (PIs) or appendix B (all personnel).
