...
-   Data Science Institute ["Data Drip"](https://bcf.arl.arizona.edu/news) at [Rii-datascienceinstitute\@arizona.edu](mailto:Rii-datascienceinstitute@arizona.edu) <!--# this URL is broken.  What is "Data Drip" and does it exist still? -->

-   R-Users AZ listserv, send announcement to Jeff Oliver [jcoliver\@email.arizona.edu](mailto:jcoliver@email.arizona.edu)

-   CALS Data Science Ambassadors
...
We have a mastodon account [\@cct_datascience\@](https://fosstodon.org/@cct_datascience)[fosstodon.org](https://fosstodon.org/@cct_datascience).
...
-   When a new user or group follows us, we should follow back if they're a collaborator, well-known organization, associated with the University, or meet the guidelines above for Following in general.
    When in doubt, check with another team member.
